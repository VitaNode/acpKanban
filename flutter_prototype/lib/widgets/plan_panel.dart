...
class PlanPanel extends StatefulWidget {
  ...
  const PlanPanel(
      {super.key, required this.plan, this.styleSheet, this.builders});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_isExpanded)
            Padding(
              padding: const EdgeInsets.fromLTRB(AppConstants.space16, 0,
                  AppConstants.space16, AppConstants.space16),
              child: Column(
