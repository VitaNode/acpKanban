class UICopy {
  ...
  static const String local = 'Local (Home/Office)';
  static const String relay = 'Relay (Remote/Cloud)';
  static const String configuration = 'CONNECTION CONFIG';
  ...
  static const String userIdMatch = 'User ID';
  static const String relayHost = 'Server Address';
  static const String relayPort = 'Server Port';
  static const String accessToken = 'Access Token (Relay)';
  static const String apiToken = 'API Token (System)';
  ...
  static const String enterLanIp = 'Enter Mac LAN IP (e.g. 192.168.x.x)';
  static const String enterCloudUrl = 'Enter Relay Server URL';
  static const String localHostOnly = 'Localhost (Mac Only)';
